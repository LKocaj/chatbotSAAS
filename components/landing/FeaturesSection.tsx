...
const features = [
  ...
  },
  {
    ...
    description: 'Web, SMS, WhatsApp, and Messenger — all conversations in one place.',
    accent: '#ffeb99',
    details: {
      headline: 'One inbox, every channel',
      body: 'Stop switching between apps. Manage all customer conversations from a single dashboard with full context and history.',
      stats: [
